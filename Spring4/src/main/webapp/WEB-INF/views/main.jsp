...
<body>
	...
	<script type="text/javascript">
		...
		function goDelete(idx) {
			$.ajax({
				url : "boardDelete.do/" + idx, // boardDelete.do?idx=7 -> boardDelte.do/7
				type : "get",
				success : loadList,
				error : function() {
					alert("error...");
		...
		function loadList() {
			// Server로 부터 게시글 정보를 비동기로 가져오는 기능
					...
					.each(
							...
							function(index, obj) {
								...
								if (obj.imgpath != null) {
									...
									list += "<img width='200px' src='resources/board/pic3.jpg'>";
								}
